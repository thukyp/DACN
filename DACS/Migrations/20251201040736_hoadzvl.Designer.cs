...
namespace DACS.Migrations
{
    ...
    [Migration("20251201040736_hoadzvl")]
    partial class hoadzvl
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DACS.Models.CauHoiThuongGap", b =>
                {
                    ...
                    b.Property<string>("TrainingSentence")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");
            ...
            modelBuilder.Entity("DACS.Models.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DACS.Models.LoTonKho", b =>
                {
                    b.Property<string>("MaLoTonKho")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
                    ...
                    b.Property<decimal>("KhoiLuongBanDau")
                        .HasColumnType("decimal(18, 2)");

                    b.Property<decimal>("KhoiLuongConLai")
                        .HasColumnType("decimal(18, 2)");
            ...
            modelBuilder.Entity("DACS.Models.SanPhamYeuThich", b =>
                {
                    b.Property<string>("M_YeuThich")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");
            ...
            modelBuilder.Entity("DACS.Models.ChiTietThuGom", b =>
                {
                    ...
                    b.HasOne("DACS.Models.LoTonKho", "LoTonKho")
                        .WithMany("ChiTietThuGoms")
                        .HasForeignKey("MaLoTonKho");
